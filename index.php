...
<html>
<head>
	<title>Online Shop Jombang</title>
...
<body>
	<div id="header">
		...
		<label>Online Shop Jombang</label>
			<ul>
...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="privacy.php"><i class="icon-info-sign"></i>Artikel</a></li>
				<li><a href="faqs.php"><i class="icon-question-sign"></i>Berita</a></li>
				<li><a href="aboutus.php"><i class="icon-bookmark"></i>Tentang Kita</a></li>
				<li><a href="contactus.php"><i class="icon-inbox"></i>Hubungi Kita</a></li>
			</ul>
	</div>
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h1><legend> <strong> Selamat Datang Di Online Shop Kami </strong> </legend></h1></center>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Teknik Informatika A </p>
		</div>
